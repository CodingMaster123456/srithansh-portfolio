  ...
  return (
    <main className="min-h-screen px-6 py-16 sm:px-12 sm:py-24 max-w-4xl mx-auto">
      ...
      <section className="flex flex-col sm:flex-row gap-8 mb-16">
        ...
        <div className="space-y-4 text-graphite leading-relaxed">
          <p>
            ...
            <span className="text-ink font-medium">Your University Name</span>
      ...
      <section className="mb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-5 border border-line rounded-xl p-5">
          
          <div className="flex flex-col justify-center py-1">
            <h3 className="font-semibold text-lg">Your University Name</h3>
            <p className="text-graphite">College of Computing</p>
            <p className="font-mono text-sm text-signal mt-2">2024 – 2028</p>
            <p className="text-graphite text-sm mt-2">
              B.S. Computer Science — Concentrations in AI/ML
            </p>
          </div>
        </div>
      </section>
